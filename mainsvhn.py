...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        "../IDL_Project/models/SVHN_Shufflenet{}".format(seed))
...
file_hdlr = logging.FileHandler('../IDL_Project/logs/log_{}.log.log'.format(datetime.datetime.now()))
